...
export default function EditTicket() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://172.16.1.251:5001/get_tiket/${id}`)
            .then(response => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`http://172.16.1.251:5001/edit_tiket/${id}`, newData);
    ...
    return (
        ...
        <div className="space-y-12">
            ...
            <h2 className="text-base font-semibold leading-7 text-gray-900">Feedback Laporan</h2>
            <p className="mt-1 text-sm leading-6 text-gray-600">
                Laporkan kembali jika masih ada masalah.
            </p>
