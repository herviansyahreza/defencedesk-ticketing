...
export default function EditUser() {
    ...
    useEffect(() => {
        ...
        axios.get(`http://172.16.1.251:5001/get_user/${id}`)
            .then(response => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const response = await axios.put(`http://172.16.1.251:5001/update/${id}`, newData);
    ...
    return (
        <form onSubmit={handleSubmit}>
            <div className="space-y-12">
                ...
                <h2 className="text-base font-semibold leading-7 text-gray-900">Formulir Pengguna yang akan diubah</h2>
                <p className="mt-1 text-sm leading-6 text-gray-600">
                    Isi sesuai dengan user yang akan diubah.
                </p>
